...
pub trait CircuitBuilderTruncatedSha256<F: RicherField + Extendable<D>, const D: usize> {
...
impl<F: RicherField + Extendable<D>, const D: usize> CircuitBuilderTruncatedSha256<F, D>
...
mod tests {
    ...
    use crate::common::builder::hash::hash192::{WitnessHash192, CircuitBuilderHash192};
