...
use crate::common::builder::hash::hash192::{Hash192Target, WitnessHash192, CircuitBuilderHash192};
use crate::common::builder::hash::sha256_truncated::CircuitBuilderTruncatedSha256;
use crate::common::richer_field::RicherField;

pub fn compute_merkle_root<F: RicherField + Extendable<D>, const D: usize>(
...
impl MerkleProofTruncatedSha256Gadget {
    ...
    pub fn set_witness<F: RicherField, W: WitnessHash192<F>>(
        &self,
        witness: &mut W,
        index: u64,
        value: &[u8; 24],
...
pub fn compute_merkle_root_from_leaves_sha256_192<F: RicherField+Extendable<D>, const D: usize>(builder: &mut CircuitBuilder<F, D>, leaves: &[Hash192Target]) -> Hash192Target{
