...
use crate::common::{
    builder::optional_inputs::CircuitBuilderOptionalInputs,
    hash::merkle::helpers::merkle_proof::{DeltaMerkleProof, DeltaMerkleProofBase},
    WHashOut,
};
...
impl DeltaMerkleProofGadget {
    pub fn add_virtual_to<H: AlgebraicHasher<F>, F: RichField + Extendable<D>, const D: usize>(
        ...
        let siblings = (0..height).map(|_| builder.add_virtual_hash()).collect();
    ...
    pub fn set_witness<F: RichField>(
        ...
        index: F,
        old_value: WHashOut<F>,
        new_value: WHashOut<F>,
